	...
	// 바 차트생성
	function makeBarChart3( div_id, pWidth, pHeight ){
		...
		// 색상 팔레트
		var barColors = d3.scaleOrdinal().range(["steelblue", "darkslategray", "yellowgreen", "yellow"]);
		...
		// 데이터 조회 (line차트)
		d3.json(	
					"./data/chart3/groupbar_line.json",
					function(error, data) {
							//**************************** ① 초기화 ***************************************************************
							...
							var box_padding = {left: 5, top: 25};	// legend BOX padding
