	...
	// 바 차트생성
	function makeBarChart6( div_id, pWidth, pHeight ){
		...
		// 색상 팔레트
		var lineColors = [ "yellowgreen", "darkslategray", "steelblue" ];
		...
		d3.json(	
					...
					function(error, data) {
							...
							var spacing = [0, 110, 220];	// 각 legend 사이 간격 수동조절
